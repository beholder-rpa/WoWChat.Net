...
[PacketHandler(WorldCommand.SMSG_CHAR_ENUM, WoWExpansion.WotLK)]
public class EnumerateCharactersPacketHandlerWotLK : EnumerateCharactersPacketHandlerTBC
{
  public EnumerateCharactersPacketHandlerWotLK(ILogger<EnumerateCharactersPacketHandlerWotLK> logger)
    : base(logger)
  {
  }
  ...
  protected override IList<GameCharacter> ParseCharEnum(Packet msg)
  {
    ...
    for (int i = 0; i < numberOfCharacters; i++)
    {
      ...
      var customizeFlags = msg.ByteBuf.ReadBytes(4); // character customize flags WotLK only
      ...
      var bags = msg.ByteBuf.ReadBytes(4 * 9); // bag display for WotLK has all 4 bags
      ...
      result.Add(new GameCharacter()
      {
        ...
        CustomizeFlags = customizeFlags.GetArrayCopy(),
